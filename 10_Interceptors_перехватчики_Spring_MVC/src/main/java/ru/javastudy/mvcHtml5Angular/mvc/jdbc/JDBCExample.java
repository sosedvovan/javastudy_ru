...
//    этот бин спринг создаст автоматом тк он прописан в application-context.xml
    @Autowired
    DataSource dataSource; //look to application-context.xml bean id='dataSource' definition

    //этот объект инициализируем в конструкторе
    ...
    public boolean insertLog(DBLog log) {
        ...
        jdbcTemplate.update(new PreparedStatementCreator() {
            public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
                //connection нам дают в параметры метода
    ...
    public boolean deleteUSER(int iduser) {
        ...
        //вместо ? подставится Object[]{iduser}
