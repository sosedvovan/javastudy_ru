...
<%--Обратите внимание на использование тегов jsp:page (указывает на файл шаблона,
см. описание тега в начале страницы) и jsp:body (контент внутри этого тега будет вставлен в
необходимое место, указанное в шаблоне).--%>
