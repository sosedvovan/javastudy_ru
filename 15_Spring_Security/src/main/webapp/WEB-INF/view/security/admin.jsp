...
<%--Для авторизованного пользователя с ролью ADMIN
Без авторизации клиента перекинет на страницу авторизации.
А в случае авторизованного пользователя, но с другой ролью
(например USER) страница будет выглядеть так: status 403--%>
<page:template>
    <jsp:body>
        <!-- Page Content -->
        <div class= "container">
