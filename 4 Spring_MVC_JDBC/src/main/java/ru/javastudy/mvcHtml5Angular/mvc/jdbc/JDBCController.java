...
/**
 * Контроллер обрабатывает запросы с jdbc.jsp страницы
 * нашего приложения. JDBCController:
 * в нем происходит автосвязывание с классом-репозиторием JDBCExample.
 * Он служит для непосредственного обращения к данным в базе
 */
@Controller
public class JDBCController {
    ...
    //ModelAndView - Этот интерфейс позволяет нам передавать всю информацию,
    //необходимую Spring MVC, в одном возврате:
