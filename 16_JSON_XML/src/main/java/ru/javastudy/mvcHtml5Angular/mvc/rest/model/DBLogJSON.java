 ...
 * будут описаны в пункте по RestTemplate. Т.к. для JSON формата никаких аннотаций
 * или дополнительных манипуляций с классом не требуется, то рассмотрим только
 * классы с суффиксом XML.
 */
