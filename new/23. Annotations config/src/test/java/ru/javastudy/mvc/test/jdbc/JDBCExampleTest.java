...
@ContextConfiguration(locations = {"classpath:_mvc-config.xml", "classpath:_application-context.xml"})
public class JDBCExampleTest {

//IMPORTANT - DISABLE THIS <bean class="org.springframework.web.servlet.view.XmlViewResolver"> in _mvc-config.xml
