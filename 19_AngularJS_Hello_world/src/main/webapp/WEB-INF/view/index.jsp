...
<%--текст будет меняться в зависимости от выбранной локали
надпись будет браться из messages_en.properties или из messages_ru.properties
в зависимости какой язык выбран - русский иди английский--%>
